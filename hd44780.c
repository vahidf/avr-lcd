...
hd44780_outbyte(uint8_t b, uint8_t rs)
{
  ...
  tmp = b >> 4;
  ASSIGN(PORT, HD44780_D4, tmp);
  tmp = b & 0x0f;
  ASSIGN(PORT, HD44780_D0, tmp);
...
hd44780_init(void)
{
  ...
  ASSIGN(DDR, HD44780_D4, 0x0F);
  //added by vahid
  ASSIGN(DDR, HD44780_D0, 0xFF);
  
  _delay_ms(15);		/* 40 ms needed for Vcc = 2.7 V */
  hd44780_outnibble(HD44780_FNSET(1, 0, 0) >> 4, 0); //if8bit, twoline, font5*10 
  _delay_ms(4.1);
  ...
  hd44780_outnibble(HD44780_FNSET(1, 1, 0) >> 4, 0);
